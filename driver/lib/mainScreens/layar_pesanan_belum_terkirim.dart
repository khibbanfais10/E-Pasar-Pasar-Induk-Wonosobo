...
class LayarPesananBelumTerkirim extends StatefulWidget {
  const LayarPesananBelumTerkirim({Key? key}) : super(key: key);

  @override
  State<LayarPesananBelumTerkirim> createState() =>
      _LayarPesananBelumTerkirimState();
}

class _LayarPesananBelumTerkirimState extends State<LayarPesananBelumTerkirim> {
  @override
    ...
    return SafeArea(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where("status", isEqualTo: "pengiriman")
            .snapshots(),
        builder: (c, snapshot) {
