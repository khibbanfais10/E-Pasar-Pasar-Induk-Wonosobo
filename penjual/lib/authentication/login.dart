...
import 'package:penjual/authentication/auth_screen.dart';
import 'package:penjual/global/global.dart';
import 'package:penjual/mainScreens/home_screen.dart';
import 'package:penjual/widgets/custom_text_field.dart';
  ...
  formValidation() {
    if (emailController.text.isNotEmpty && passwordController.text.isNotEmpty) {
      ...
      showDialog(
          ...
          builder: (c) {
            return ErrorDialog(
              message: "Harap Masukkan email/password",
            );
          });
    }
  }
      ...
      if (snapshot.exists) {
        if (snapshot.data()!["status"] == "approved") {
          ...
          await sharedPreferences!
              .setString("email", snapshot.data()!["penjualEmail"]);
          await sharedPreferences!
              .setString("name", snapshot.data()!["penjualName"]);
          await sharedPreferences!
